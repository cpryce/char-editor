...
export function newCharacterDraft(): CharacterDraft {
  return {
    ...
    inventory: {
      wornSlots: {
        head:      { item: '', weight: '', acType: '', acBonus: 0 },
        face:      { item: '', weight: '', acType: '', acBonus: 0 },
        neck:      { item: '', weight: '', acType: '', acBonus: 0 },
        shoulders: { item: '', weight: '', acType: '', acBonus: 0 },
        bodySlot:  { item: '', weight: '', acType: '', acBonus: 0 },
        chest:     { item: '', weight: '', acType: '', acBonus: 0 },
        wrists:    { item: '', weight: '', acType: '', acBonus: 0 },
        hands:     { item: '', weight: '', acType: '', acBonus: 0 },
        ringLeft:  { item: '', weight: '', acType: '', acBonus: 0 },
        ringRight: { item: '', weight: '', acType: '', acBonus: 0 },
        waist:     { item: '', weight: '', acType: '', acBonus: 0 },
        feet:      { item: '', weight: '', acType: '', acBonus: 0 },
      },
      body: null,
      mainHand: null,
      offHandWeapon: null,
