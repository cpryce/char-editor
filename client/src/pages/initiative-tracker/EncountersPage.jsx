        ...
        <ul className="flex flex-col gap-3">
          {encounters.map((s, i) => (
            ...
            >
              ...
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); deleteEncounter(s.id); }}
                title="Delete encounter"
                style={{ color: 'black', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '24px', height: '24px' }}
              >
