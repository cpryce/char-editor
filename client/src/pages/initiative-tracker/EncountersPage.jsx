...
export function EncountersPage({ onOpenEncounter }) {
  ...
  return (
    <div className="px-6 py-8">
      <h2 className="text-xl font-semibold mb-1" style={{ color: 'var(--color-fg-default)', display: 'flex', alignItems: 'center', gap: '8px' }}>
        <svg width="28" height="28" viewBox="0 0 512 512" fill="none" aria-hidden="true" style={{ display: 'block', flexShrink: 0 }}>
          <path
