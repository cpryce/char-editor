...
- Name: character-editor.spec.ts >> Character Editor >> Form Validation >> Save Character is disabled when class is selected but name is empty
- Location: e2e/character-editor.spec.ts:120:9
