...
- Name: characters.spec.ts >> Characters Page >> Custom Skills sidebar item is disabled
- Location: e2e/characters.spec.ts:75:7
...
Locator: getByRole('button', { name: 'Custom Skills' })
Expected: disabled
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Custom Skills' })
