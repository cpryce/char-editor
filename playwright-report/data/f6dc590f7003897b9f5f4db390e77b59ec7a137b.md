...
- Name: character-editor.spec.ts >> Character Editor >> Form Validation >> Save Character becomes enabled when both name and class are filled
- Location: e2e/character-editor.spec.ts:127:9
