...
- Name: character-editor.spec.ts >> Character Editor >> Form Validation >> Save Character is disabled when name is filled but no class selected
- Location: e2e/character-editor.spec.ts:113:9
