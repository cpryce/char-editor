...
- Name: character-editor.spec.ts >> Character Editor >> Form Validation >> autosave does not fire when name is filled but no class selected
- Location: e2e/character-editor.spec.ts:122:9
