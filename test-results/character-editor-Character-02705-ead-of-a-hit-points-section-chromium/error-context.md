...
- Name: character-editor.spec.ts >> Character Editor >> Layout >> shows a derived hit points field under the class selector instead of a hit points section
- Location: e2e/character-editor.spec.ts:43:9
