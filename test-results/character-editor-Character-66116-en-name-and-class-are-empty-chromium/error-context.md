...
- Name: character-editor.spec.ts >> Character Editor >> Form Validation >> autosave does not fire when name and class are empty
- Location: e2e/character-editor.spec.ts:108:9
