...
- Name: characters.spec.ts >> Characters Page >> shows an error message when the API request fails
- Location: e2e/characters.spec.ts:90:7
...
Locator: getByText('Failed to load characters')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Failed to load characters')
