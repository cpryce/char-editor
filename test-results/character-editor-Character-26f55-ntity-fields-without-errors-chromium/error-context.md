...
- Name: character-editor.spec.ts >> Character Editor >> Identity Fields >> can fill optional identity fields without errors
- Location: e2e/character-editor.spec.ts:326:9
