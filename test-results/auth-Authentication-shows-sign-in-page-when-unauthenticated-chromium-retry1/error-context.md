...
Locator: getByRole('heading', { name: 'char-editor', level: 1 })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'char-editor', level: 1 })
...
- main [ref=e3]:
  - generic [ref=e4]:
    - heading "AD&D (3.5e) Tools" [level=1] [ref=e5]
    - link "Sign in with Google" [ref=e6] [cursor=pointer]:
      - /url: /auth/google
```
