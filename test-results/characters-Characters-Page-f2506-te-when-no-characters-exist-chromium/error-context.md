...
- Name: characters.spec.ts >> Characters Page >> shows empty state when no characters exist
- Location: e2e/characters.spec.ts:19:7
...
Locator: getByText('No characters yet.')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('No characters yet.')
