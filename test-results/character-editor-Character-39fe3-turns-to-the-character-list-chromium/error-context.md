...
- Name: character-editor.spec.ts >> Character Editor >> Navigation >> Character Editor nav menu → Characters returns to the character list
- Location: e2e/character-editor.spec.ts:98:9
