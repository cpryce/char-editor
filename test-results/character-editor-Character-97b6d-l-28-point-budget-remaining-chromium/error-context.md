...
- Name: character-editor.spec.ts >> Character Editor >> Layout >> starts all base ability scores at 8 and shows full 28-point budget remaining
- Location: e2e/character-editor.spec.ts:64:9
