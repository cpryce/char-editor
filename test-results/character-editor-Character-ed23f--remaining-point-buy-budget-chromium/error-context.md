...
- Name: character-editor.spec.ts >> Character Editor >> Identity Fields >> ability scores cannot go below 8 or exceed the remaining point-buy budget
- Location: e2e/character-editor.spec.ts:338:9
