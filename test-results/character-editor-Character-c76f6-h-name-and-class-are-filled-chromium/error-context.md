...
- Name: character-editor.spec.ts >> Character Editor >> Form Validation >> autosave fires when both name and class are filled
- Location: e2e/character-editor.spec.ts:150:9
