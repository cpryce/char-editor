...
- Name: characters.spec.ts >> Characters Page >> shows the Characters heading
- Location: e2e/characters.spec.ts:5:7
...
Locator: getByRole('heading', { name: 'Characters', level: 2 })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Characters', level: 2 })
